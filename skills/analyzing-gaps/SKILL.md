...
1. Read journey file from `grimoires/keeper/journeys/{journey-id}.md`
2. Extract:
...
1. Read canvas from `grimoires/keeper/canvas/{username}.md`
2. Extract:
...
1. Find reality file:
   ...
   - Otherwise search `grimoires/keeper/reality/` for matches
